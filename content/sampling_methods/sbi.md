...
In *reweighted sampling*, we use the samples from the prior in [](#eqn:prior_samples), but assign them a self-normalised importance weight. The weights and self-normalised weights are defined as
